...
This reference describes Sticks Lite v1.0. Sticks Lite is small on purpose: every rule is meant to be teachable, predictable, and visible to a beginning programmer.
...
Dictionary iteration is not supported in v1.0.
...
Users cannot define, create, raise, or throw custom errors in v1.0.
